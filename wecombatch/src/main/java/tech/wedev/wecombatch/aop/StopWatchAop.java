...
import tech.wedev.wecombatch.utils.CPUMonitorUtils;
...
//    @Around("pointCut()")
    @SneakyThrows
    @Around(value = "@annotation(tech.wedev.wecombatch.annos.StopWatch)")
    public Object doAround(ProceedingJoinPoint pjp) {
        ...
        log.info("测试RAM结束，测试CPU占用率约为：" + monitorService.getMonitorInfoBean().getCpuRatio() + "，内存占用空间约为 : " + (beforeRAM - afterRAM) + "M" + "，Java Heap Size: " + heapSize + "M");
        return proceed;
    }
